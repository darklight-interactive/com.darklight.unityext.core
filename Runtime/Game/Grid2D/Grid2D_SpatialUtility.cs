...
{
    public static class Grid2D_SpatialUtility
    {
        ...
        static Vector2Int CalculateCoordinateFromKey(Vector2Int key, Grid2D_Config config)
        {
            Vector2Int originKey = CalculateOriginKey(config);
            return key - originKey;
        }

        static Vector2Int CalculateOriginKey(Grid2D_Config config)
        {
