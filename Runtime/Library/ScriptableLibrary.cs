...
namespace Darklight.Library
{
    ...
    using UnityEditor;
#endif
    public abstract class ScriptableLibrary<TKey, TValue, TLib>
        : ScriptableObject,
            ILibrary<TKey, TValue>
        where TKey : notnull
        ...
        where TLib : Library<TKey, TValue>, new()
    {
        ...
        public bool TryGetValue(TKey key, out TValue value) =>
            DataLibrary.TryGetValue(key, out value);
        ...
        {
            get => DataLibrary.ReadOnlyKey;
            set => DataLibrary.ReadOnlyKey = value;
        }
        public bool ReadOnlyValue
        {
            get => DataLibrary.ReadOnlyValue;
            set => DataLibrary.ReadOnlyValue = value;
        }
        public IEnumerable<TKey> RequiredKeys
        {
            get => DataLibrary.RequiredKeys;
            set => DataLibrary.RequiredKeys = value;
        }
        ...
        public bool TryGetKeyByValue(TValue value, out TKey key) =>
            DataLibrary.TryGetKeyByValue(value, out key);

        public bool TryGetKeyByValue<T>(out TKey key)
            where T : TValue => DataLibrary.TryGetKeyByValue<T>(out key);
    ...
    public abstract class EnumObjectScriptableLibrary<TKey, TValue>
        : ScriptableLibrary<TKey, TValue, EnumObjectLibrary<TKey, TValue>>
        where TKey : Enum
        where TValue : UnityEngine.Object { }

    public abstract class EnumGameObjectScriptableLibrary<TKey>
        : ScriptableLibrary<TKey, GameObject, EnumGameObjectLibrary<TKey>>
        where TKey : Enum
    {
        public TComponent TryGetComponent<TComponent>(TKey key)
