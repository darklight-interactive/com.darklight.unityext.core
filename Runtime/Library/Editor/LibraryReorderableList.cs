...
namespace Darklight.UnityExt.Library.Editor
{
    ...
    public class LibraryReorderableList : ReorderableList
    {
            ...
            : base(serializedObject, itemsProperty, DRAGGABLE, true, true, true)
        {
            ...
            this._columnPercentages = ValidateAndNormalizePercentages(
                COLUMN_COUNT,
                COLUMN_PERCENTAGES
            );
        ...
        private void DrawElementProperty(
            Rect rect,
        ...
        private void DrawValueField(Rect rect, SerializedProperty valueProperty)
        {
            ...
            {
                valueProperty.vector2Value = EditorGUI.Vector2Field(
                    rect,
                    GUIContent.none,
            ...
            {
                valueProperty.vector3Value = EditorGUI.Vector3Field(
                    rect,
                    GUIContent.none,
        ...
        private float[] ValidateAndNormalizePercentages(int expectedColumns, float[] percentages)
        {
            ...
            float evenPercentage =
                providedCount < expectedColumns
                    ? remainingPercentage / (expectedColumns - providedCount)
                    : 0f;
