...
namespace Darklight.UnityExt.Input.Editor
{
    ...
    public class InputDebugWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/Darklight/Input Debug")]
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.LabelField(
                ...
                HasListeners(_target.OnSecondaryInteractCanceled) ? _activeStyle : _inactiveStyle
            );
            EditorGUILayout.LabelField(
                "Menu Button Started:",
