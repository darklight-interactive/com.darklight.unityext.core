...
namespace Darklight.UnityExt.Core2D
{
    ...
    public class MatrixSpawnerComponentPreset : ScriptableObject
    {
        [Header("Flags")]
        ...
        /// </summary>
        [SerializeField, NonReorderable] List<MatrixNode.SpawnerComponent.InternalData> _serializedCellSpawnData = new List<MatrixNode.SpawnerComponent.InternalData>();
        ...
        public List<MatrixNode.SpawnerComponent.InternalData> SerializedSpawnData { get => _serializedCellSpawnData; set => _serializedCellSpawnData = value; }
    }
}