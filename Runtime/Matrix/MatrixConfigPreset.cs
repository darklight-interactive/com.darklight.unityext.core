...
namespace Darklight.UnityExt.Matrix
{
    ...
    public class MatrixConfigPreset : ScriptableObject
    {
        ...
        // ======== [[ METHODS ]] ======================================================= >>>>
        public MatrixNode.NodeConfig CreateCellConfig()
        {
            MatrixNode.NodeConfig config = new MatrixNode.NodeConfig();
        ...
        public void UpdateConfig(Matrix.Config config)
        {
