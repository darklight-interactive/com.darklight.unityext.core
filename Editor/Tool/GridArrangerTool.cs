...
namespace Darklight.Editor
{
    ...
    /// </summary>
    public class GridArrangerTool : EditorWindow
    {
        ...
        /// </summary>
        [MenuItem(EditorPath.MENU_TOOL + "GridArranger")]
        public static void ShowWindow()
        {
            var window = GetWindow<GridArrangerTool>("Darklight Grid Arranger");
        ...
        {
            [SerializeField] public bool autoCalculate = true;

            [SerializeField] public DistributionPlane distributionPlane = DistributionPlane.XZ;

            [SerializeField] public Vector3Int gridSize = new Vector3Int(3, 3, 3);

            [SerializeField] public PositionType positionType = PositionType.Auto;

            [SerializeField] public Vector2 randomRange = new Vector2(0, 10);

            [SerializeField] public Vector2 randomRotationRange = new Vector2(0, 360);

            [SerializeField] public RotationType rotationType = RotationType.None;

            [SerializeField] public bool snapToGrid = true;

            [SerializeField] public Vector3 spacing = new Vector3(2f, 2f, 2f);

            [SerializeField] public float spacingMultiplier = 1.1f;

            [SerializeField] public Vector3 targetRotation = Vector3.zero;
