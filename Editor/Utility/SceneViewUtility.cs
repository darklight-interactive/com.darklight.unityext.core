...
namespace Darklight.UnityExt.Editor.Utility
{
	...
	public static class SceneViewUtility
	{
		...
		public static Vector3 GetDirectionVector(ViewDirection direction)
		{
			switch (direction)
			{
				case ViewDirection.TOP: return Vector3.up;
				case ViewDirection.BOTTOM: return Vector3.down;
				case ViewDirection.LEFT: return Vector3.left;
				case ViewDirection.RIGHT: return Vector3.right;
				case ViewDirection.FRONT: return Vector3.forward;
				case ViewDirection.BACK: return Vector3.back;
